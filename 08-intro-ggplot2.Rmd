...
```{r, ex="exercise_num8.1", type="sample-code", height=500}
#Your code
```


```{r, ex="exercise_num8.1", type="solution", height=500}
#Solution
library(ggplot2)

internet_url<-"https://raw.githubusercontent.com/balsaedi/-R-Visualization/main/gapminder_internet.csv"
# Read the csv file
