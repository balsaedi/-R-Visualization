...
# Define UI
ui <- fluidPage(
  titlePanel("Interactive Scatter Plot in Shiny App"),
...
# Define UI
ui <- fluidPage(
  titlePanel("Interactive Scatter Plot in Shiny APP with user update"),
  sidebarLayout(
    sidebarPanel(
      sliderInput("slider", "Number of points to show:", 
                  min = 5, max = nrow(iris), value = 50)
    ),
    mainPanel(
