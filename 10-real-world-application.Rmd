...
1. Read in the cleaned [patients](https://github.com/balsaedi/-R-Visualization/raw/main/patient-data.txt) dataset, `patient-data-cleaned.txt`, into a new object called `patients`.
