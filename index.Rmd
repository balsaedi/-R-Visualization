...
```{r, tutorial::go_interactive(greedy=FALSE)}
# Addition
2 + 3
# Subtraction
5 - 2
...
Your turn! Add 35 to 65. Subtract 70 from 200. Multiply 6 by 8, divide 65 by 5 and lastly raise 9 to the power of 10. 


```{r ex="dtype_num1", type="sample-code"}
# Add 35 to 65.

# Subtract 70 from 200.

# Multiply 6 by 8

# Divide 65 by 5 

# Raise 9 to the power of 10.
...
Try to assign 10 to a variable called m and 89 to a variable called n. Create a new variable called p which is the sum of m and n. 

```{r ex="dtype_num2", type="sample-code"}
# Write your code here 

# Print p

```
```{r ex="dtype_num2", type="solution"}
m<-10
n<-89
p<-m+n
...
If you did it right, the final answer should be 99.
...
nums <- c(1, 2, 3, 4, 5, 9, 12, 45,78)
nums[1]   # Access the first element of nums
nums[2:4] # Access the second to fourth elements of nums
nums[6] # Access the  sixth element of nums

```


Write a sequence of numbers from 2 to 1000 that increase by 17 and store them in a vector called seq. Access the 15th number. What do you get?

```{r ex="dtype_num3", type="sample-code"}
# Your code

# Print the 15th number

```
```{r ex="dtype_num3", type="solution"}
# Generate the sequence
seq <- seq(from = 2, to = 1000, by = 17)

# Access the 15th number
number_15 <- seq[15]
...
The correct answer should be `240`.
...
Define your own function  called perform_operation to perform addition, subtraction, division, and multiplication with three arguments (x,y,operation). Ensure that the function prints the result or returns an error in a division by zero and print the error message, "Error: Division by zero".

```{r ex="dtype_num4", type="sample-code"}
# Define your function called perform_operation here with three arguments (x,y,operation).

#Test the function
x<-10
y<-5
# Addition
perform_operation(x, y, "addition")

# Subtraction
perform_operation(x, y, "subtraction")

# Multiplication
perform_operation(x, y, "multiplication")

# Division
perform_operation(x, y, "division")

```
```{r ex="dtype_num4", type="solution"}
# Define a function for basic mathematical operations
perform_operation <- function(x, y, operation) {
  result <- switch(operation,
                   "addition" = x + y,
                   "subtraction" = x - y,
                   "multiplication" = x * y,
                   "division" = if(y != 0) x / y else "Error: Division by zero")
  print(result)
}
...
```{r ex="exercise_num1", type="sample-code"}
# Your code
```
...
```{r ex="exercise_num2", type="sample-code"}
#Your code
```
...
```{r ex="exercise_num3", type="sample-code"}
...
```{r ex="exercise_num4", type="sample-code"}
#Your code
```
...
```{r ex="exercise_num5", type="sample-code", height=500}
#Your code
```
